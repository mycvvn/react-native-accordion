        ...
        return (
            <View style={styles.panelWrapper}>
                <Button
                    ...
                    containerStyle={[styles.panelButton, {
                ...
                >
                    <View style={styles.titleWrapper}>
                        ...
                        {this.props.showChevron && (
                            <Fragment>
                                {this.isOpen ? (
                                    <Icon name="chevron-up" size={this.props.iconSize} color={this.props.iconColor} />
                                ) : (
                                    <Icon name="chevron-down" size={this.props.iconSize} color={this.props.iconColor} />
                                )}
                            </Fragment>
                        )}
                    </View>
